...
@section('content')
    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('projectHolders.index') }}">Porteurs de Projets</a></li>
            ...
            <div class="col-lg-6">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('projectHolders.store') }}">
                            @csrf
                        ...
                        @else
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    @foreach ($employees as $administrator)
                                        <tr>
